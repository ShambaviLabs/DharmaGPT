        ...
        if metadata.get("review_status") in {None, "", "pending", "needs_work"}:
            ...
            pending.append(
                ManualTranslationRecord(
                    ...
                    text_en_manual=record.get("text_en_manual"),
                    translation_mode=record.get("translation_mode") or metadata.get("translation_mode"),
                    translation_backend=record.get("translation_backend") or metadata.get("translation_backend"),
                    translation_version=record.get("translation_version") or metadata.get("translation_version"),
                    translation_fallback_reason=record.get("translation_fallback_reason") or metadata.get("translation_fallback_reason"),
